...
for(i; i < starWarsCharacters.length; i++){
  if(starWarsCharacters[i].gender === "female"){
    femaleCharacters[i] = starWarsCharacters[i]
    console.log("flag")//per verificare quante volte sono entrato nella condizione IF
  }
}
...
const eyeColor = {
  ...
  brown: [],
  red: [],
  "blue-gray": [] // Nota: poiché "blue-gray" contiene un trattino, è necessario usare le virgolette per definire la chiave.
}
...
for(i; i<starWarsCharacters.length; i++){
  switch(starWarsCharacters[i].eye_color){
    case "blue":
      eyeColor.blue[eyeColor.blue.length] = starWarsCharacters[i]
      break

    case "yellow":
      eyeColor.yellow[eyeColor.yellow.length] = starWarsCharacters[i]
      break
    
    case "brown":
      eyeColor.brown[eyeColor.brown.length] = starWarsCharacters[i]
      break
    
    case "red":
      eyeColor.red[eyeColor.red.length] = starWarsCharacters[i]
      break

    case "blue-gray":
      eyeColor["blue-gray"][eyeColor["blue-gray"].length] = starWarsCharacters[i]
...
for(i; i<characters.length; i++){
  for(j; j<femaleCharacters.length;  j++){
